    ...
    (function () {
      ...
      (function (exports, global) {
        ...
        exports.requestFileSystem = function (
          ...
          var storageName = (location.protocol + location.host).replace(
            /:/g,
            "_"
          );
        ...
        exports.removeRecursively = exports.remove = function (
          successCallback,
          errorCallback,
          args
        ) {
        ...
        var MyFileHelper = {
          toJson: function (myFile, success) {
            ...
            fr.onload = function (ev) {
              var base64 = btoa(
                String.fromCharCode.apply(null, new Uint8Array(fr.result))
              );
              success({
                opt: {
                  size: myFile.size,
            ...
            if (cursor) {
              ...
              results.push(
                val.isFile
                  ...
                  : new DirectoryEntry(val.name, val.fullPath, val.filesystem)
              );
              cursor.continue();
            }
          };
        ...
        idb_.delete = function (
          ...
          tx.oncomplete = function () {
            if (isDirectory) {
              ...
              var range = IDBKeyRange.bound(
                fullPath + " ",
                fullPath + String.fromCharCode(unicodeLastChar)
              );
