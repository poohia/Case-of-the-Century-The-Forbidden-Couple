cordova.define(
  ...
  function (require, exports, module) {
    ...
    Entry.prototype.moveTo = function (
      ...
      // copy
      exec(success, fail, "File", "moveTo", [
        srcURL,
        parent.toInternalURL(),
        name,
      ]);
    };
